...
{
    /// <summary>
    /// <para>Subscribes a MouseButtonEventHandler to an IEventHandler with a user-specified lambda, and propagates the sender, args, and event (as an IEvent) as outputs
    ...
    /// </summary>
    public class MouseButtonEvent : IEventHandler // sender
    {
        ...
        private IDataFlow<MouseButtonEventArgs> argsOutput;
        private IEvent eventHappened;

        /// <summary>
        /// <para>Subscribes a MouseButtonEventHandler to an IEventHandler with a user-specified lambda, and propagates the sender, args, and event (as an IEvent) as outputs.</para>
        /// <para>The Lambda definition should follow the following format:<code>Lambda = (sender, args) => { ... }</code></para>
        /// </summary>
        public MouseButtonEvent(string eventName)
        {
        ...
        public void Subscribe(string eventName, object sender)
        {
            ...
            try
            {
                ...
                senderEvent.AddEventHandler(sender, new MouseButtonEventHandler((o, args) =>
                {
