...
namespace DomainAbstractions
{
    ...
    /// <para>Ports:</para>
    /// <para>1. IEvent start: Signals to start the process. Use this when the condition is set via the Condition property rather than through an IDataFlow&lt;bool&gt;.</para>
