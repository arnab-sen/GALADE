...
{
    /// <summary>
    /// <para>Subscribes a MouseEventHandler to an IEventHandler with a user-specified lambda, and propagates the sender, args, and event (as an IEvent) as outputs
    ...
    /// </summary>
    public class MouseEvent : IEventHandler
    {
        // Public fields and properties
        public string InstanceName = "Default";
        public MouseEventHandler Lambda;
        public Predicate<MouseEventArgs> Condition;
        ...
        /// <summary>
        /// <para>Subscribes a MouseEventHandler to an IEventHandler with a user-specified lambda, and propagates the sender, args, and event (as an IEvent) as outputs.</para>
        /// <para>The Lambda definition should follow the following format:<code>Lambda = (sender, args) => { ... }</code></para>
        /// </summary>
        public MouseEvent(string eventName)
        {
        ...
        public void Subscribe(string eventName, object sender)
        {
            ...
            try
            {
                ...
                senderEvent.AddEventHandler(sender, new MouseEventHandler((o, args) =>
                {
