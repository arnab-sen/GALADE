...
namespace Application
{
    ...
    public class Application
    {
        ...
        private void CreateWiring()
        {
            ...
            Data<IEnumerable<ALANode>> getRoots = new Data<IEnumerable<ALANode>>() {InstanceName="getRoots",Lambda=() =>{    var roots = mainGraph.Roots.OfType<ALANode>();    return roots;}}; /* {"IsRoot":false} */
            ...
            DispatcherEvent id_61b3caf63ee84893babc3972f0887b44 = new DispatcherEvent() {InstanceName="Default"}; /* {"IsRoot":false} */
            ...
            ForEach<ALANode> id_2efd4f283c7b4df49b82383e24773e7d = new ForEach<ALANode>() {InstanceName="id_2efd4f283c7b4df49b82383e24773e7d"}; /* {"IsRoot":false} */
            ...
            ApplyAction<bool> id_ce0bcc39dd764d1087816b79eefa76bf = new ApplyAction<bool>() {InstanceName="id_ce0bcc39dd764d1087816b79eefa76bf",Lambda=isChecked =>{    layoutDiagram.UseBreadthFirst = !isChecked;}}; /* {"IsRoot":false} */
            ...
            EventLambda id_f81835850c0d4098bb59b38f8b7ce974 = new EventLambda() {InstanceName="id_f81835850c0d4098bb59b38f8b7ce974",Lambda=() => layoutDiagram.InitialY = 50}; /* {"IsRoot":false} */
            ...
            id_7356212bcc714c699681e8dffc853761.WireTo(getRoots, "fanoutList"); /* {"SourceType":"EventConnector","SourceIsReference":false,"DestinationType":"Data","DestinationIsReference":false} */
            ...
            id_4a268943755348b68ee2cb6b71f73c40.WireTo(id_f81835850c0d4098bb59b38f8b7ce974, "delayedEvent"); /* {"SourceType":"DispatcherEvent","SourceIsReference":false,"DestinationType":"EventLambda","DestinationIsReference":false} */
            ...
            id_dd81a5ed9ff0413facf64a3ea65c2cf5.WireTo(id_fe211cb0ce564e329374aa81c0e90975, "eventHappened"); /* {"SourceType":"KeyEvent","SourceIsReference":false,"DestinationType":"EventLambda","DestinationIsReference":false} */
