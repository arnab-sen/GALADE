...
namespace Application
{
    ...
    public class Application
    {
        ...
        private void CreateWiring()
        {
            ...
            var cloneSelectedNodeModel = new Data<AbstractionModel>() {InstanceName="cloneSelectedNodeModel",Lambda=() =>{    var selectedNode = mainGraph.Get("SelectedNode") as ALANode;    if (selectedNode == null)        return null;    var baseModel = selectedNode.Model;    var clone = new AbstractionModel(baseModel);    return clone;}}; /* {"IsRoot":false} */
